...
#define MGOS_LSM6DSL_REG_FUNC_CFG_ACCESS             (0x01) // ok
#define MGOS_LSM6DSL_REG_SENSOR_SYNC_TIME_FRAME      (0x04)
#define MGOS_LSM6DSL_REG_SENSOR_SYNC_RES_RATIO       (0x05)
#define MGOS_LSM6DSL_REG_FIFO_CTRL1                  (0x07) // ok
#define MGOS_LSM6DSL_REG_FIFO_CTRL2                  (0x08) // ok
#define MGOS_LSM6DSL_REG_FIFO_CTRL3                  (0x09) // ok
#define MGOS_LSM6DSL_REG_FIFO_CTRL4                  (0x0A) // ok
// #define MGOS_LSM6DSL_REG_FIFO_CTRL5                  (0x0A)
#define MGOS_LSM6DSL_REG_DRDY_PULSE_CFG_G            (0x0B)
#define MGOS_LSM6DSL_REG_INT1_CTRL                   (0x0D) // ok
#define MGOS_LSM6DSL_REG_INT2_CTRL                   (0x0E) // ok
#define MGOS_LSM6DSL_REG_WHO_AM_I                    (0x0F)
#define MGOS_LSM6DSL_REG_CTRL1_XL                    (0x10) // ok
#define MGOS_LSM6DSL_REG_CTRL2_G                     (0x11) // ok
#define MGOS_LSM6DSL_REG_CTRL3_C                     (0x12) // ok
#define MGOS_LSM6DSL_REG_CTRL4_C                     (0x13) // ok
#define MGOS_LSM6DSL_REG_CTRL5_C                     (0x14) // ok
#define MGOS_LSM6DSL_REG_CTRL6_C                     (0x15) // ok
#define MGOS_LSM6DSL_REG_CTRL7_G                     (0x16) // ok
#define MGOS_LSM6DSL_REG_CTRL8_XL                    (0x17) // ok
#define MGOS_LSM6DSL_REG_CTRL9_XL                    (0x18) // ok
#define MGOS_LSM6DSL_REG_CTRL10_C                    (0x19) // ok
#define MGOS_LSM6DSL_REG_WAKE_UP_SRC                 (0x1B) // ok
#define MGOS_LSM6DSL_REG_TAP_SRC                     (0x1C) // ok
#define MGOS_LSM6DSL_REG_D6D_SRC                     (0x1D) // ok
#define MGOS_LSM6DSL_REG_STATUS_REG                  (0x1E) // ok
#define MGOS_LSM6DSL_REG_OUT_TEMP_L                  (0x20) // ok
#define MGOS_LSM6DSL_REG_OUT_TEMP_H                  (0x21) // ok
#define MGOS_LSM6DSL_REG_OUTX_L_G                    (0x22) // ok
#define MGOS_LSM6DSL_REG_OUTX_H_G                    (0x23) // ok
#define MGOS_LSM6DSL_REG_OUTY_L_G                    (0x24) // ok
#define MGOS_LSM6DSL_REG_OUTY_H_G                    (0x25) // ok
#define MGOS_LSM6DSL_REG_OUTZ_L_G                    (0x26) // ok
#define MGOS_LSM6DSL_REG_OUTZ_H_G                    (0x27) // ok
...
#define MGOS_LSM6DSL_REG_FIFO_STATUS1                (0x3A) // ok
#define MGOS_LSM6DSL_REG_FIFO_STATUS2                (0x3B) // ok
...
#define MGOS_LSM6DSL_REG_TAP_CFG0                    (0x56) //maybe
#define MGOS_LSM6DSL_REG_TAP_CFG1                    (0x57) //maybe
#define MGOS_LSM6DSL_REG_TAP_CFG2                    (0x58) //maybe
#define MGOS_LSM6DSL_REG_TAP_THS_6D                  (0x59) // ok
#define MGOS_LSM6DSL_REG_INT_DUR2                    (0x5A) // ok
#define MGOS_LSM6DSL_REG_WAKE_UP_THS                 (0x5B) // ok
#define MGOS_LSM6DSL_REG_WAKE_UP_DUR                 (0x5C) // ok
#define MGOS_LSM6DSL_REG_FREE_FALL                   (0x5D) // ok
#define MGOS_LSM6DSL_REG_MD1_CFG                     (0x5E) // ok
#define MGOS_LSM6DSL_REG_MD2_CFG                     (0x5F) // ok
#define MGOS_LSM6DSL_REG_MASTER_CMD_CODE             (0x60) // maybe
